...
if __name__ == "__main__":
    ...
    Vs_t, vs_t, _ = EMLikeAlg(Y_t, Cb_t, Cr_t, w_t, j=args.J_dim, k=args.K_clusters, steps=args.steps, alphas=(1.0, 1.0, 1.0))
    assign_t = assign_points(Y_t, Cb_t, Cr_t, Vs_t, vs_t, w=w_t)
